                ...
                <Auth title="SIGN IN" subTitle="TO TOUCHSTONE ADMIN">
                    <form method="post" action="/login/" name="contact-form" id="contact-form">
                      ...
                      <InputGroup fullWidth className="d-block position-relative form-group">
                        <label className="control-label d-block" fullWidth>Username</label>
                        <input className="form-control" type="text" id="username" name="user" required/>
                          {/* <i className="fas fa-user" aria-hidden="true"></i> */}
                          <EvaIcon name="person" className="font-icon"/>
                      </InputGroup>

                      <InputGroup fullWidth className="d-block position-relative form-group">
                          <label className="control-label d-block" fullWidth>Password</label>
                          <input className="form-control" id="password" name="pass" type="password" required />
                        <EvaIcon name="lock" className="font-icon"/>
                      </InputGroup>
                      
                      <Button status="Success" type="button" shape="SemiRound" fullWidth className="mt-3">
                        Login
                      </Button>
