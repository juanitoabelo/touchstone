            ...
            <Container>
                <Row>
                  <Col breakPoint={{ xs: 12 }}>
                    <h1 className="mb-5">Insurance Search</h1>
                  </Col>
                </Row>
                  ...
                  <form>
                      <Row>
                        ...
                        <Col breakPoint={{ xs: 12 }} breakPoint={{ md: 6 }}>
                            <Button status="Success" type="button" shape="SemiRound" onClick={onSearchInsurance} fullWidth>Search</Button>
                        </Col>
                    </Row>
