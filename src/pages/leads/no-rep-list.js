...
export default function NoRepList() {
  return (
    <>
                    ...
                    <CardBody className="p-5">
                      <form>
                        ...
                        <Col breakPoint={{ xs: 12 }} className="d-flex justify-content-center">
                          <Button className="mx-1" status="Success" type="button" shape="square" onClick={selStatus} value="Active">Active</Button>
                          <Button className="mx-1" status="Success" type="button" shape="square" onClick={selStatus} value="Referred">Referred</Button>
                          <Button className="mx-1" status="Success" type="button" shape="square" onClick={selStatus} value="Deactivated">Deactivated</Button>
                          <Button className="mx-1" status="Success" type="button" shape="square" onClick={selStatus} value="Admin">Admin</Button>
                          <Button className="mx-1" status="Success" type="button" shape="square" onClick={selStatus} value="All">All</Button>
                        </Col>
                        </Row>
                        <Row>
