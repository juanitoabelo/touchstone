...
const selectServiceOption = [
  { value: '189', label: 'Debbie Celani' },
  { value: '35', label: 'Debra Celani' },
...
export default function EmployeeStats() {
  ...
  return (
    <>
      <SEO title="Employee Stats Report" />
            ...
            <Container>
                <Row>
                  <Col breakPoint={{ xs: 12 }}>
                    <h1 className="text-center mb-5">Employee Stats Report</h1>
                  </Col>
                </Row>
                  ...
                  <Card>
                    <CardBody className="p-5">
                      <form>
                          <Row>
                          <Col breakPoint={{ xs: 12 }}>
                              <label htmlFor="SelUserID">Service</label>
                              <SelectStyled options={selectServiceOption}  placeholder="--Select Employee--" id="SelUserID" name="SelUserID" onChange ={onChangeStatus.bind(this)} />
                            </Col>
