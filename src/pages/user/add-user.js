                  ...
                  <form>
                      <Row>
                        ...
                        <Col breakPoint={{ xs: 12 }} breakPoint={{ md: 6 }}>
                          ...
                          <SelectStyled options={selectDepartmentOptions}  placeholder="Select" id="DepartmentID" name="DepartmentID" onChange ={onChangeStatus.bind(this)} />
                        </Col>

                        <Col breakPoint={{ xs: 12 }} breakPoint={{ md: 6 }}>
                            <Button status="Success" type="button" shape="SemiRound" onClick={onSearchProduct} fullWidth>Save New Users</Button>
                        </Col>
                    </Row>
